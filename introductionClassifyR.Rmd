...
# Part 2: Practical application to AML data
...
The aim is to build classification models to predict resistance, and to estimate the error rate using cross-validation.
...
* Differential network (Advanced extension)

--

Compare the cross-validation error rates between these methods.

Follow the [Activity document](https://github.com/SydneyBioX/TrainClassifyR/tree/master/activities) available online for this Part.
